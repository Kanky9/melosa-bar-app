    ...
    <div className="space-y-8">
      <header className="text-center my-8">
        <h1 className="text-5xl font-extrabold tracking-tight text-foreground">
          Bienvenido a <span className="text-primary text-shadow-subtle">Melosa Bar</span>
        </h1>
              ...
              <div className="space-y-6">
                {groupedAndFilteredProducts.map((group) => (
                  <div key={group.category.id}>
                    <h3 className="text-2xl font-semibold mb-3 text-primary border-b pb-2 text-shadow-subtle">{group.category.name}</h3>
